#!/usr/bin/env bash
# Regenerate ALL user-facing artefacts in Aegon/transcripts/.
# Run by the user: bash Aegon/transcripts/build_all.sh
set -euo pipefail
cd "$(dirname "$0")"
...
# ── Build PDFs ────────────────────────────────────────────────────────────────
echo "Building 2026-07-10-kickoff-summary.pdf ..."
build_pdf 2026-07-10-kickoff-summary.md 2026-07-10-kickoff-summary.pdf
echo "OK  Aegon/transcripts/2026-07-10-kickoff-summary.pdf"
